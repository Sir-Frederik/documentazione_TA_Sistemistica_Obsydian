...
GitLab è la piattaforma **SCM** (Source Code Management) del team — ospita i repository Git del codice sorgente. Come [[🫖Jenkins]], **non esegue i progetti direttamente**: li archivia e li versiona.
